    ...
    case JournalEntry::Topic::pagestate:
        switch (static_cast<const journalEntry::Pagestate*>(&entry)->type)
        {
            ...
            case journalEntry::Pagestate::Type::success:
                /**
                 * This is intentionally left out to assure
                 * this never gets written into flash.
                 * This is only to be generated by a topic by interpreting other actions
                 * such as setRootnode or updateTreeNode or commitPAC.
                 */
                return 0;
